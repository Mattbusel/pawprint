"""Pawprint Pro: the one in-app purchase, and the switch from paid to free.
...
PRODUCT_ID = "com.mattbusel.pawprint.pro"
NAME = "Pawprint Pro"
PRICE = "3.99"
...
REVIEW_NOTE = (
    ...
    "Pawprint Pro card at the bottom of the Pets tab. Restore purchase is on the paywall and on that card."
)
